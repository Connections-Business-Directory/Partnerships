=== Connections Business Directory Partnerships ===
Contributors: shazahm1@hotmail.com
Donate link: http://connections-pro.com/
Tags: business directory, partnerships
...
What does this plugin do? It adds the ability to add partnerships and assign them to you business directory entries.

The partnerships of an entry can optionally be shown as a content block within a template or with the supplied widget int the theme's sidebar.
...
2. Search for `connections business directory partnerships `.
...
1. [Download the plugin zip file](https://wordpress.org/plugins/connections-business-directory-partnerships/) and save it to your computer.
2. Navigate to the `Add New` sub-page under the Plugins admin page.
3. Click the `Upload` link.
4. Select Connections Business Directory Partnerships zip file from where you saved the zip file on your computer.
...
1. [Download the plugin zip file](https://wordpress.org/plugins/connections-business-directory-partnerships/) and save it to your computer.
2. Extract the Connections Business Directory Partnerships zip file.
3. Create a new directory named `connections-business-directory-partnerships ` directory in the `../wp-content/plugins/` directory.
...
1. Add new business partnerships admin page.
2. Assign partnerships to business directory listing.
3. Partnership Content Block.
4. Partnership widget display.
