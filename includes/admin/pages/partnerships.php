...
function connectionsShowPartnershipsPage() {
	...
	if ( ! current_user_can( 'connections_edit_categories' ) ) {
		...
		if ( $action === "edit_{$taxonomy}" ) {
			...
			<div class="wrap">
				<div class="form-wrap" style="width:600px; margin: 0 auto;">
					<h1><a name="new"></a><?php _e( 'Edit Partnership', 'connections_partnerships' ); ?></h1>
					...
					<div class="form-field form-required term-name-wrap">
						<label for="term_name"><?php _e( 'Name', 'connections_partnerships' ) ?></label>
						...
						<p><?php _e( 'The name is how it appears on your site.', 'connections_partnerships' ); ?></p>
					</div>

					<div class="form-field term-slug-wrap">
						<label for="term_slug"><?php _e( 'Slug', 'connections_partnerships' ); ?> </label>
					...
					<div class="form-field term-parent-wrap">
						<label for="term_parent"><?php _e( 'Parent', 'connections_partnerships' ); ?></label>
						...
						cnTemplatePart::walker(
							...
							array(
								...
								'hierarchical'     => TRUE,
								'show_option_none' => __( 'None', 'connections_partnerships' ),
								//'return'           => TRUE,
							)
						);
						?>
					...
					$cancelURL = add_query_arg( 'page', 'connections_partnerships', self_admin_url( 'admin.php' ) );
					?>

					<!--<input type="hidden" name="cn-action" value="update_category"/>-->

					<p class="submit">
						<a class="button button-warning" href="<?php echo esc_url( $cancelURL ); ?>"><?php _e( 'Cancel', 'connections_partnerships' ); ?></a>
						<input type="submit" name="update" id="update" class="button button-primary" value="<?php _e( 'Update Partnership', 'connections_partnerships' ); ?>"/>
					</p>
		...
		<?php
			...
			<div class="wrap nosubsub">
				...
				<h1>Connections : <?php _e( 'Partnerships', 'connections_partnerships' ); ?></h1>

				<form class="search-form" action="" method="get">

					<input type="hidden" name="page" value="<?php echo esc_attr( $_REQUEST['page'] ); ?>"/>
					<?php $table->search_box( __( 'Search Partnerships', 'connections_partnerships' ), $taxonomy ); ?>
				...
				<div id="col-container">
					...
					<div id="col-right">
						<div class="col-wrap">
									...
									$(document).ready(function () {
										$('#doaction, #doaction2').click(function () {
											if ($('select[name^="action"]').val() == 'delete') {
												var m = 'You are about to delete the selected partnership(s).\n  \'Cancel\' to stop, \'OK\' to delete.';
							...
							<div class="form-wrap">
								<p><?php _e(
										'<strong>Note:</strong><br/>Deleting a partnership which has been assigned to an entry will reassign that entry to the default partnership.',
										'connections_partnerships'
									); ?></p>
							</div>
					...
					<div id="col-left">
						<div class="col-wrap">
							...
							<div class="form-wrap">
								<h3><?php _e( 'Add New Partnership', 'connections_partnerships' ); ?></h3>
								...
								submit_button( __( 'Add New Partnership', 'connections_partnerships' ), 'primary', 'add' );
